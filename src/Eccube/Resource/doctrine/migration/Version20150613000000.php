...
class Version20150613000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (1, 'キッチンツール', NULL, 1, 5, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (2, 'インテリア', NULL, 1, 6, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (3, '食器', 1, 2, 3, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (4, '調理器具', 1, 2, 4, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (5, 'フォーク', 3, 3, 2, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");
        $this->addSql("INSERT INTO dtb_category (category_id, category_name, parent_category_id, level1, rank, creator_id, create_date, update_date, del_flg) VALUES (6, '新入荷', NULL, 1, 1, 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 0)");

        $this->addSql("INSERT INTO dtb_category_count (category_count_id, product_count, create_date) VALUES (1, 1, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_count (category_count_id, product_count, create_date) VALUES (4, 1, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_count (category_count_id, product_count, create_date) VALUES (5, 1, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_count (category_count_id, product_count, create_date) VALUES (6, 2, CURRENT_TIMESTAMP)");

        $this->addSql("INSERT INTO dtb_category_total_count (category_total_count_id, product_count, create_date) VALUES (1, 2, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_total_count (category_total_count_id, product_count, create_date) VALUES (3, 2, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_total_count (category_total_count_id, product_count, create_date) VALUES (4, 1, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_total_count (category_total_count_id, product_count, create_date) VALUES (5, 1, CURRENT_TIMESTAMP)");
        $this->addSql("INSERT INTO dtb_category_total_count (category_total_count_id, product_count, create_date) VALUES (6, 2, CURRENT_TIMESTAMP)");
...
いまだけ、おいしい淹れ方の冊子つきです。')");
        ...
        if ($this->connection->getDatabasePlatform()->getName() == "oracle") {
            // シーケンスを設定
            $this->addSql("ALTER SEQUENCE dtb_base_info_id_seq INCREMENT BY 2");
            $this->addSql("SELECT dtb_base_info_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_member_member_id_seq INCREMENT BY 2");
            $this->addSql("SELECT dtb_member_member_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_tax_rule_tax_rule_id_seq INCREMENT BY 1");
            $this->addSql("SELECT dtb_tax_rule_tax_rule_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_block_block_id_seq INCREMENT BY 11");
            $this->addSql("SELECT dtb_block_block_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_page_layout_page_id_seq INCREMENT BY 31");
            $this->addSql("SELECT dtb_page_layout_page_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_category_category_id_seq INCREMENT BY 6");
            $this->addSql("SELECT dtb_category_category_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_CLASS_NAME_CLASS_NAME_ID_S INCREMENT BY 2");
            $this->addSql("SELECT DTB_CLASS_NAME_CLASS_NAME_ID_S.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_CLASS_CATEGORY_CLASS_CATEG INCREMENT BY 6");
            $this->addSql("SELECT DTB_CLASS_CATEGORY_CLASS_CATEG.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_delivery_delivery_id_seq INCREMENT BY 2");
            $this->addSql("SELECT dtb_delivery_delivery_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_payment_payment_id_seq INCREMENT BY 4");
            $this->addSql("SELECT dtb_payment_payment_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_delivery_fee_fee_id_seq INCREMENT BY 94");
            $this->addSql("SELECT dtb_delivery_fee_fee_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_delivery_time_time_id_seq INCREMENT BY 3");
            $this->addSql("SELECT dtb_delivery_time_time_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_delivery_date_date_id_seq INCREMENT BY 9");
            $this->addSql("SELECT dtb_delivery_date_date_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_MAIL_TEMPLATE_TEMPLATE_ID_ INCREMENT BY 5");
            $this->addSql("SELECT DTB_MAIL_TEMPLATE_TEMPLATE_ID_.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_news_news_id_seq INCREMENT BY 1");
            $this->addSql("SELECT dtb_news_news_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_product_product_id_seq INCREMENT BY 2");
            $this->addSql("SELECT dtb_product_product_id_seq.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_CLASS_PRODUCT_CLAS INCREMENT BY 10");
            $this->addSql("SELECT DTB_PRODUCT_CLASS_PRODUCT_CLAS.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_STOCK_PRODUCT_STOC INCREMENT BY 11");
            $this->addSql("SELECT DTB_PRODUCT_STOCK_PRODUCT_STOC.nextval from dual");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_IMAGE_PRODUCT_IMAG INCREMENT BY 6");
            $this->addSql("SELECT DTB_PRODUCT_IMAGE_PRODUCT_IMAG.nextval from dual");
            $this->addSql("ALTER SEQUENCE dtb_template_template_id_seq INCREMENT BY 4");
            $this->addSql("SELECT dtb_template_template_id_seq.nextval from dual");

            // シーケンスを戻す
             $this->addSql("ALTER SEQUENCE dtb_base_info_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_member_member_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_tax_rule_tax_rule_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_block_block_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_page_layout_page_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_category_category_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_CLASS_NAME_CLASS_NAME_ID_S INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_CLASS_CATEGORY_CLASS_CATEG INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_delivery_delivery_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_payment_payment_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_delivery_fee_fee_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_delivery_time_time_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_delivery_date_date_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_MAIL_TEMPLATE_TEMPLATE_ID_ INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_news_news_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_product_product_id_seq INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_CLASS_PRODUCT_CLAS INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_STOCK_PRODUCT_STOC INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE DTB_PRODUCT_IMAGE_PRODUCT_IMAG INCREMENT BY 1");
            $this->addSql("ALTER SEQUENCE dtb_template_template_id_seq INCREMENT BY 1");
        }
